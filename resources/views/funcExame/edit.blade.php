...
@section('title', 'Editar dados do exame')
        ...
        <form method="post" action="{{ route('funcExame.update', $funcExame->id) }}" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group mb-3">
                    ...
                    <textarea name="anotacao" class="form-control bg-light" rows="5" style="width: 100%;">{{ $funcExame->anotacao }}</textarea>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-4">
                    ...
                    <input type="text" name="duracao" class="form-control bg-light"
                        value="{{ $exame->duracao }} {{ $exame->tipo_periodo }}" readonly>
                </div>
                <div class="col-3">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#obter-data').click(function() {
                $.ajax({
                    url: '/data-validade-exame/' + <?php echo $exame->id; ?>, 
                    method: 'GET',
